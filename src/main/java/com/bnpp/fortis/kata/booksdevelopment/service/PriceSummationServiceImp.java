...
public class PriceSummationServiceImp  implements  PriceSummationService{
	...
	public void calculatePriceWithDiscount(Map<String, Integer> listOfbooksWithQuantityMap,
										   List<Integer> listOfPossibleDiscounts, CartSummaryReportDto cartSummaryReportDto) {
		listOfPossibleDiscounts.stream().forEach(numberOfBooksToGroup -> {
			...
			List<BookGroupClassification> listOfBookGroupClassification = getListOfBooksWithPossibleDiscount(bookQuantityMapCopy, new ArrayList<BookGroupClassification>(),
	...
	private List<BookGroupClassification> getListOfBooksWithPossibleDiscount(Map<String, Integer> listOfBooksWithQuantityMap,
